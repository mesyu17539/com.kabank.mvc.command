...
/*			sel=DriverManager.getConnection(
			...
			while(sel.next()) {
				member=new ResultMap();
				member.getMember().setId(sel.getString("ID"));
				member.getMember().setPass(sel.getString("PASS"));
				list.getMembers().add(member.getMember());
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
		System.out.println("=====ID : "+member.getMember().getId());
		System.out.println("=====pass : "+member.getMember().getPass());
	...
	public ResultMap selectMemberById() {
		...
		try {
			...
			while(rs.next()) {
				...
				bea.getMember().setId(rs.getString("id"));
				bea.getMember().setPass(rs.getString("pass"));
				bea.getMember().setName(rs.getString("name"));
				bea.getMember().setSsn(rs.getString("ssn"));
				bea.getMember().setPhone(rs.getString("phone"));
				bea.getMember().setEmail(rs.getString("email"));
				bea.getMember().setProfile(rs.getString("profile"));
				bea.getMember().setAddr(rs.getString("addr"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
